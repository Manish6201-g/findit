...
const ClaimSchema = new mongoose_1.Schema({
    item: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Item', required: true, index: true },
    claimer: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
